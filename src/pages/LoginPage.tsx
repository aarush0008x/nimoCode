    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-24">
      <div className="w-full max-w-md p-8 rounded-3xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-2xl space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-bold">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-[11px] text-amber-600 dark:text-amber-400 font-bold hover:underline">
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <p className="text-center text-xs text-neutral-500 pt-2">
          ...
          <Link to="/signup" className="text-neutral-950 dark:text-white font-bold hover:underline">
            Sign Up Real Account
          </Link>
        </p>
      </div>
    </div>
