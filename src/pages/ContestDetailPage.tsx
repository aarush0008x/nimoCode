      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-3xl bg-neutral-950 text-white border border-neutral-800 shadow-xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-400">{contest.subtitle}</p>
          </div>
        </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <span className="w-7 h-7 rounded-xl bg-amber-500/10 text-amber-500 font-mono text-xs font-bold flex items-center justify-center">
                      {prob.code}
                    </span>
